...
select model,brand  from cars where brand = 'Hyundai';
select brand, model ,color  from cars where color in('Red','Blue');
select brand,model,year_of_issue from cars where year_of_issue between 2000 and 2010;
select  count(id)  ,brand from cars group by brand having brand = 'Chevrolet' ;
select avg(year_of_issue),brand,model  from cars group by brand, model;
select brand, model,year_of_issue from cars where brand in ('Audi','Toyota','Kia','Ford');
select brand,model from cars where model like 'T%';
select brand,model from cars where model like '%e';
select brand from cars where brand like '_____' ;
select count(brand) from cars where brand in ('Mercedes-Benz');
SELECT concat(brand ,' ',model,' ',price) as max_car FROM cars WHERE price = (SELECT MAX(price) FROM cars);
select brand from cars where brand not in ('Toyota');
